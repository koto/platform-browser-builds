 ...
 * @publicApi
 */
export declare const TRUSTED_TYPE_POLICY_NAME: InjectionToken<string>;
 ...
 * @publicApi
 */
export declare abstract class ɵangular_packages_platform_browser_platform_browser_h {
    ...
    abstract maybeCreateTrustedValueForAttribute(el: any, name: string, value: string, namespace?: string): string;
...
export declare class ɵangular_packages_platform_browser_platform_browser_i extends ɵangular_packages_platform_browser_platform_browser_h {
    private _name;
    private _policy;
    ...
    maybeCreateTrustedValueForAttribute(el: Element, name: string, value: string, namespace?: string): string;
    private _getContext;
}

export declare function ɵangular_packages_platform_browser_platform_browser_j(transitionId: string, document: any, injector: Injector): () => void;

export declare const ɵangular_packages_platform_browser_platform_browser_k: StaticProvider[];

export declare function ɵangular_packages_platform_browser_platform_browser_l(coreTokens: core.NgProbeToken[]): any;
...
export declare class ɵDomRendererFactory2 implements RendererFactory2 {
    ...
    constructor(eventManager: EventManager, sharedStylesHost: ɵDomSharedStylesHost, policyAdapter: ɵangular_packages_platform_browser_platform_browser_h);
...
export declare class ɵDomSanitizerImpl extends DomSanitizer {
    private _doc;
    private _policyAdapter;
    constructor(_doc: any, _policyAdapter: ɵangular_packages_platform_browser_platform_browser_h);
